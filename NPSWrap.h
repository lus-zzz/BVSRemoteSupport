...
signals:
    ...
    void signal_addPorxy(QString clientId,QString localPort,QString remark,bool isTcp = true);
    void signal_addSuccess(QString text);
    void signal_deleteClient(QString clientId);


public slots:
    void slot_addClient(QString reqip, QString reqport, QString key, QString remark = "BVSRemoteSupport");
    void slot_addPorxy(QString clientId, QString localPort, QString remark, bool isTcp);
